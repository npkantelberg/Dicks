...
final class DUPX_S3_Funcs
{
    ...
    {
        /**
         * temp workaround, remove this with new template system and MVC structure
         */
        if (!DUPX_Ctrl_Params::setParamsStep3()) {
    ...
    public function initLog()
    {
        ...
        $skipOpts = array('tables', 'plugins', 'dbpass', 'json', 'search', 'replace', 'wp_password');
